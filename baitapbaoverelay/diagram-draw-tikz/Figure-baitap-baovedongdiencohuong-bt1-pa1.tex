...
\begin{document}
	\begin{tikzpicture}[>=triangle 45]
		...
		\draw (7.9, 0) -- (8.4, 0); \draw (8.4,0.2) rectangle (9,-0.2); \draw (8.7,-.2) node[below]{$5$}; \draw (9, 0) -- (10,0);\draw (10,0.2) rectangle (10.6,-0.2); \draw (10.3,-.2) node[below]{$6$}; \draw (10.6,0) -- (11.1,0);  \draw (8.2,0.6)-- (8,0.3) -- (8.3,0.3); \draw[->] (8.3,0.3) -- (7.35,-.5); \draw (8.4,0.6) node[above]{$N_2$}; \draw[->] (8.4,0.4) -- (9, 0.4);
		...
		\draw (11.1, 0) -- (11.6, 0); \draw (11.6,0.2) rectangle (12.2,-0.2); \draw (11.9,-.2) node[below]{$7$}; \draw (12.2, 0) -- (13.2,0);\draw (13.2,0.2) rectangle (13.8,-0.2); \draw (13.5,-.2) node[below]{$8$}; \draw (13.8,0) -- (14.3,0); \draw[->] (11.6,0.4) -- (12.2, 0.4);

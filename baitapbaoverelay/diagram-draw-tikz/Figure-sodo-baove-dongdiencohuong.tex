...
\begin{document}
	\begin{tikzpicture}[>=triangle 45]
		\draw (0,0) circle (.5)  node{\LARGE{$\mathbf{\sim}$}}; \draw (0,0.5) node[above]{$F_1$}; 
		\draw (0.5, 0) -- (1.5,0);
		...
		\draw (4.7, 0) -- (5.2, 0); \draw (5.2,0.2) rectangle (5.8,-0.2); \draw (5.8,-.2) node[below]{$3$}; \draw (5.8, 0) -- (6.8,0);\draw (6.8,0.2) rectangle (7.4,-0.2); \draw (7.1,-.2) node[below]{$4$}; \draw (7.4,0) -- (7.9,0); \draw[->] (5.2,0.4) -- (5.8,0.4); \draw[<-] (6.8,0.4) -- (7.4,0.4);
		...
		\draw (11.1, 0) -- (12.1, 0); \draw (12.6,0) circle (.5)  node{\LARGE{$\mathbf{\sim}$}}; \draw (12.6,0.5) node[above]{$F_2$}; 
	\end{tikzpicture}
\end{document} 